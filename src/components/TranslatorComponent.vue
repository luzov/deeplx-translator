<template>
  <div class="translator">
    <div class="language-selector">
      ...
      <el-button @click="swapLanguages" circle>
    ...
    <el-button type="primary" @click="translate" :loading="isTranslating"
      >翻译</el-button
    >

    <el-input
      v-if="alternativeTranslations.length > 0"
      v-model="alternativeTranslationsText"
      type="textarea"
      :rows="4"
      placeholder="替代翻译"
      readonly
      ...
      <el-table :data="apiUrls">
        ...
        <el-table-column>
          <template #default="scope">
            <el-button type="danger" @click="removeApiUrl(scope.$index)"
              >删除</el-button
            >
          </template>
        </el-table-column>
